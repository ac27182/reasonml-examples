...
//   clientName: string,
//   message: string,
//   client: option(WebSocket.t),
//   channels: list(Types.channelInfo),
// };
// type action =
//   | AddClient(option(WebSocket.t), string, string)
//   | RemoveClient
...
//   let websocket = WebSocket.wsbc("ws://localhost:3000/");
...
//   // };
//   let connect = (i: inputState): option(WebSocket.t) => {
//     let c =
//       WebSocket.wsbc(
//         "ws://localhost:3000/"
//         ++ i.newChannelName
...
//         state.client
//         |> Option.getOrThrow
//         |> WebSocket.send(~message=inputState.message);
